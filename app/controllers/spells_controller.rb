class SpellsController < ApplicationController
  ...
  private
    ...
    def spell_params
      params.permit(:name, :desc, :higher_level, :range, :components, :material, :ritual, :duration, :concentration, :casting_time, :level, :attack_type, :damage_at_slot_level, :school, :classes, :dc, :area_of_effect)
    end
end
